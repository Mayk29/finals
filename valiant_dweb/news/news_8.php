...
$published_date=strtotime("Saturday October 28 2023 5:04pm");
...
<!DOCTYPE html>
	...
	Section: WD-202
	Site Name: Valiant Esports - news_8.php
	Date: April 2024
	-->
<html lang = "en">

<head>
	<title>News & Updates - Igniting the Future | Valiant Esports</title>
	<meta charset = "utf-8">
		...
		<main>
            ...
            <div class="main-news">
                <section class="news-section">
                    <div class ="news-img">
                        <img src="../images/news/news_8.jpg" alt="igniting the future">
                    </div>

                    <div class="news-content">
                        <h2>Igniting the Future</h2>
                        <h3><?php $table->message(); ?></h3>
                        <p>Its is truly igniting the past as the victorious winners in the School of Computing! Your dedication and skills have led you to the top, and you've truly earned the title of champions to the foxes! See you around can't wait for the foxes return. Once again Congratulations to all the Champions! </p>
                        <p>Photos by: Karl Lacsamana</p>
                    </div>
                </section>
            </div>
