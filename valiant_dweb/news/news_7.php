...
$published_date=strtotime("Sunday October 29 2023 10:14pm");
...
<!DOCTYPE html>
	...
	Section: WD-202
	Site Name: Valiant Esports - news_7.php
	Date: April 2024
	-->
<html lang = "en">

<head>
	<title>News & Updates - Valiant Archangels secured 2nd victory | Valiant Esports</title>
	<meta charset = "utf-8">
		...
		<main>
            ...
            <div class="main-news">
                <section class="news-section">
                    <div class ="news-img">
                        <img src="../images/news/news_7.jpg" alt="Valiant Archangels won">
                    </div>

                    <div class="news-content">
                        <h2>Valiant Archangels secured 2nd victory</h2>
                        <h3><?php $table->message(); ?></h3>
                        <p>2nd match? 2nd week? No problem as the Valiant Archangels get to secure their second victory in the 2nd Week of ALLG North and Central Luzon Regionals Conference! Once again, congratulations to our Archangels!</p>
                    </div>
                </section>
            </div>
