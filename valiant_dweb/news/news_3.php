...
$published_date=strtotime("Thursday November 2 2023 5:43pm");
...
<head>
	<title>News & Updates - Be the next Creative | Valiant Esports</title>
	<meta charset = "utf-8">
		...
		<main>
            ...
            <div class="main-news">
                <section class="news-section">
                    <div class ="news-img">
                        <img src="../images/news/news_3.jpg" alt="be the next creative">
                    </div>

                    <div class="news-content">
                        <h2>Be the next Creative!</h2>
                        <h3><?php $table->message(); ?></h3>
                        <p>Dare yourself to be Creative! Share your wit, innovation, and creativity with the Valiant Family! Got a heart willing to commit to Valiant? Join now and be a vital part of the creative team. Redefine the gaming experience as applications start now!  </p>
                        <p><a href ="https://tinyurl.com/BECREATIIVE" target="_blank" style="color: #fff; text-decoration: none;"><span>BECREATIIVE Registration Link</span></a></p>
                    </div>
                </section>
            </div>
