...
<?php 
    ...
    $published_date=strtotime("Sunday October 29 2023 10:16pm");
?>
<?php
...
<!DOCTYPE html>
	...
	Section: WD-202
	Site Name: Valiant Esports - news_6.php
	Date: April 2024
	-->
<html lang = "en">

<head>
	<title>News & Updates - Valiant Camael defeated Panthera Esports | Valiant Esports</title>
	<meta charset = "utf-8">
		...
		<main>
            ...
            <div class="main-news">
                <section class="news-section">
                    <div class ="news-img">
                        <img src="../images/news/news_6.jpg" alt="Valiant Camael won">
                    </div>

                    <div class="news-content">
                        <h2>Valiant Camael defeated Panthera Esports</h2>
                        <h3><?php $table->message(); ?></h3>
                        <p>With their unparalleled tenacity and high intelligence in the game, the Valiant Camael overcame the formidable Panthera Esports last week to secure their 2nd win in the ALLG North and Central Luzon Regionals Conference!</p>
                    </div>
                </section>
            </div>
