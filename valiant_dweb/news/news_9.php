...
$published_date=strtotime("Sunday October 22 2023 11:55am");
...
<!DOCTYPE html>
	...
	Section: WD-202
	Site Name: Valiant Esports - news_9.php
	Date: April 2024
	-->
<html lang = "en">

<head>
	<title>News & Updates - Bewitching Legends | Valiant Esports</title>
	<meta charset = "utf-8">
		...
		<main>
            ...
            <div class="main-news">
                <section class="news-section">
                    <div class ="news-img">
                        <img src="../images/news/news_9.jpg" alt="bewitching legends">
                    </div>

                    <div class="news-content">
                        <h2>Bewitching Legends</h2>
                        <h3><?php $table->message(); ?></h3>
                        <p>Step into the realm of gaming mastery as the college days of School of Arts and Sciences begin! Congratulations to Team Violet as they who conquered and emerged as the ultimate gaming legends. Once again Congratulations Team Violet! See you around! </p>
                    </div>
                </section>
            </div>
