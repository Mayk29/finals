...
$published_date=strtotime("Sunday October 29 2023 10:20pm");
...
<!DOCTYPE html>
	...
	Section: WD-202
	Site Name: Valiant Esports - news_5.php
	Date: April 2024
	-->
<html lang = "en">

<head>
	<title>News & Updates - Thriller in our 2nd Week! | Valiant Esports</title>
	<meta charset = "utf-8">
		...
		<main>
            ...
            <div class="main-news">
                <section class="news-section">
                    <div class ="news-img">
                        <img src="../images/news/news_5.jpg" alt="week 2 results">
                    </div>

                    <div class="news-content">
                        <h2>Thriller in our 2nd Week!</h2>
                        <h3><?php $table->message(); ?></h3>
                        <p>Thriller in our 2nd Week! Don't miss out on the results of our 2nd week's matches on ALLG North and Central Luzon Regionals Conference as we dominated Valorant, Call of Duty, and League of Legends in our matches! Once again congratulations team Valiant!</p>
                    </div>
                </section>
            </div>
