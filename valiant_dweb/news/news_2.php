...
$published_date=strtotime("Thursday November 2 2023 8:39pm");
...
<!DOCTYPE html>
	...
	Section: WD-202
	Site Name: Valiant Esports - news_2.php
	Date: April 2024
	-->
<html lang = "en">

<head>
	<title>News & Updates - SIKLAB | Valiant Esports</title>
	<meta charset = "utf-8">
		...
		<main>
            ...
            <div class="main-news">
                <section class="news-section">
                    <div class ="news-img">
                        <img src="../images/news/news_2.jpg" alt="SIKLAB">
                    </div>

                    <div class="news-content">
                        <h2>SIKLAB presents Blazing the flame through Esports</h2>
                        <h3><?php $table->message(); ?></h3>
                        <p>Tune in with TSU VULPHOX Esports General Assembly: Blazing the flame through Esports on November 4th. As our Events Management Executive, Lou Russel Rodrigo was invited as a Guest speaker, let's show our support as he share's his leadership through Esports and Student Government. Mark your calendars and be a part of the Esports General Assembly on November 4th. This is an event that no one should miss! See you there!</p>
                    </div>
                </section>
            </div>
