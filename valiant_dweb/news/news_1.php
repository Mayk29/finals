...
$published_date=strtotime("Saturday November 4 2023 5:57pm");
...
<!DOCTYPE html>
	...
	Section: WD-202
	Site Name: Valiant Esports - news_1.php
	Date: April 2024
	-->
<html lang = "en">

<head>
	<title>News & Updates - Guess the Agent | Valiant Esports</title>
	<meta charset = "utf-8">
		...
		<main>
            ...
            <div class="main-news">
                <section class="news-section">
                    <div class ="news-img">
                        <img src="../images/news/news_1.jpg" alt="guess the agent">
                    </div>

                    <div class="news-content">
                        <h2>Guess the Agent</h2>
                        <h3><?php $table->message(); ?></h3>
                        <p>What's up Angelites! We are to challenge your knowledge about the game Valorant! Are you a Valorant Player or maybe a fan, well this game is for you! As the Valiant Esports is here to challenge your knowledge in our event 'Guess the Agent'. Join us and chance to win 3 Nitro Boost!</p>
                    </div>
                </section>
            </div>
