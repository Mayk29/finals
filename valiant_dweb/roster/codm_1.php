...
<!DOCTYPE html>
	...
	Section: WD-202
	Site Name: Valiant Esports - codm_1.php
	Date: April 2024
	-->
<html lang = "en">

<head>
	<title>CODM Varsity | Valiant Esports</title>
	<meta charset = "utf-8">
    <link rel="stylesheet" href="../css/styles.css" type="text/css">
	<meta name="viewport" content="width=device-width, initial-scale=1.0">
	<meta name="description" content="The Valiant Esports currently has two call of duty mobile teams."/>
...
<body>
	<div id="container-about">
		...
		<main >
			<div class = "grid">
            <aside >
                <p>VALIANT CODM VARSITY</p>
            </aside>
    
            <figure  id="roster-member"><!-- Figure Element 1 -->
                <img src ="../images/val-codm-var/val-ahv.jpg" alt = "codm team1 player 1" />
				<figcaption>ahveed</figcaption>
            </figure>
    
            <figure id="roster-member" ><!-- Figure Element 2 -->
                <img src ="../images/val-codm-var/val-not.jpg" alt = "codm team1 player 2" />
                <figcaption >fFB.GG/Notdofy</figcaption>
            </figure>
            
            <figure id="roster-member"><!-- Figure Element 3 -->
                <img src ="../images/val-codm-var/val-fate.jpg" alt = "codm team1 player 3" />
                <figcaption >F4TÈ</figcaption>
            </figure>

            <figure id="roster-member"><!-- Figure Element 4 -->
                <img src ="../images/val-codm-var/val-les.jpg" alt = "codm team1 player 4" />
                <figcaption >LestR</figcaption>
            </figure>

            <figure id="roster-member"><!-- Figure Element 5 -->
                <img src ="../images/val-codm-var/val-smo.jpg" alt = "codm team1 player 5" />
                <figcaption >smokey</figcaption>
            </figure>

			<figure id="roster-member"><!-- Figure Element 6 -->
                <img src ="../images/val-codm-var/val-smo.jpg" alt = "codm team1 player 6" />
                <figcaption >BellaWRM</figcaption>
            </figure>

			<figure id="roster-member"><!-- Figure Element 6 -->
                <img src ="../images/val-codm-var/val-tba.jpg" alt = "codm team1 player 7" />
