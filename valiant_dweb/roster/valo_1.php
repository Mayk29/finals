...
<!DOCTYPE html>
	...
	Section: WD-202
	Site Name: Valiant Esports - valo_1.php
	Date: April 2024
	-->
<html lang = "en">

<head>
	<title>Valorant Varsity | Valiant Esports</title>
	<meta charset = "utf-8">
...
<body>
    ...
    <nav>
		...
		<main >
			<div class = "grid">
            <aside >
                <p>VALIANT VALORANT VARSITY</p>
            </aside>
    
            <figure  id="roster-member"><!-- Figure Element 1 -->
                <img src ="../images/valiant-valo-var/valo-kael.jpg" alt = "valorant team1 player 1" />
				<figcaption>Kael</figcaption>
            </figure>
    
            <figure id="roster-member" ><!-- Figure Element 2 -->
                <img src ="../images/valiant-valo-var/valo-demon.jpg" alt = "valorant team1 player 2" />
                <figcaption >Demon1 #OOOO</figcaption>
            </figure>
            
            <figure id="roster-member"><!-- Figure Element 3 -->
                <img src ="../images/valiant-valo-var/valo-tba.jpg" alt = "valorant team1 player 3" />
                <figcaption >TBA</figcaption>
            </figure>

            <figure id="roster-member"><!-- Figure Element 4 -->
                <img src ="../images/valiant-valo-var/valo-tba.jpg" alt = "valorant team1 player 4" />
                <figcaption >TBA</figcaption>
            </figure>

            <figure id="roster-member"><!-- Figure Element 5 -->
                <img src ="../images/valiant-valo-var/valo-tba.jpg" alt = "valorant team1 player 5" />
                <figcaption >TBA</figcaption>
            </figure>

			<figure id="roster-member"><!-- Figure Element 6 -->
                <img src ="../images/valiant-valo-var/valo-tba.jpg" alt = "valorant team1 player 6" />
                <figcaption >TBA</figcaption>
            </figure>

            <figure id="roster-member"><!-- Figure Element 7 -->
                <img src ="../images/valiant-valo-var/valo-tba.jpg" alt = "valorant team1 player 7" />
                <figcaption >TBA</figcaption>
            </figure>
		</div>
