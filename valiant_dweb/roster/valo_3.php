...
<head>
	<title>Valorant Hearts | Valiant Esports</title>
	<meta charset = "utf-8">
...
<body>
    ...
    <nav>
		...
		<main>
			<div class = "grid">
            <aside >
                <p>VALIANT VALORANT HEARTS</p>
            </aside>
    
            <figure  id="roster-member"><!-- Figure Element 1 -->
                <img src ="../images/valiant-valo-hearts/valo-carm.jpg" alt = "valorant team3 player 1" />
				<figcaption>lalacarmela</figcaption>
            </figure>
    
            <figure id="roster-member" ><!-- Figure Element 2 -->
                <img src ="../images/valiant-valo-hearts/valo-melo.jpg" alt = "valorant team3 player 2" />
                <figcaption >mellorine#NAMI</figcaption>
            </figure>
            
            <figure id="roster-member"><!-- Figure Element 3 -->
                <img src ="../images/valiant-valo-hearts/valo-alex.jpg" alt = "valorant team3 player 3" />
                <figcaption >Alex</figcaption>
            </figure>

            <figure id="roster-member"><!-- Figure Element 4 -->
                <img src ="../images/valiant-valo-hearts/valo-tba.jpg" alt = "valorant team3 player 4" />
                <figcaption >TBA</figcaption>
            </figure>

            <figure id="roster-member"><!-- Figure Element 5 -->
                <img src ="../images/valiant-valo-hearts/valo-tba.jpg" alt = "valorant team3 player 5" />
                <figcaption >TBA</figcaption>
            </figure>
		</div>
