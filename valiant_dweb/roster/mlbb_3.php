...
<!DOCTYPE html>
	...
	Section: WD-202
	Site Name: Valiant Esports - mlbb_3.php
	Date: April 2024
	-->
<html lang = "en">

<head>
	<title>Valiant Empyrian | Valiant Esports</title>
	<meta charset = "utf-8">
...
<body>
    ...
    <nav>
		...
		<main>
			<div class = "grid">
            <aside >
                <p>VALIANT EMPYRIAN ROSTER</p>
            </aside>
    
            <figure  id="roster-member"><!-- Figure Element 1 -->
                <img src ="../images/valiant-empy/val-ben.jpg" alt = "mlbb team3 player 1" />
				<figcaption>Benny Belgs.</figcaption>
            </figure>
    
            <figure id="roster-member" ><!-- Figure Element 2 -->
                <img src ="../images/valiant-empy/val-xil.jpg" alt = "mlbb team3 player 2" />
                <figcaption >Xildius</figcaption>
            </figure>
            
            <figure id="roster-member"><!-- Figure Element 3 -->
                <img src ="../images/valiant-empy/val-kot.jpg" alt = "mlbb team3 player 3" />
                <figcaption >Kotselaa.</figcaption>
            </figure>

            <figure id="roster-member"><!-- Figure Element 4 -->
                <img src ="../images/valiant-empy/val-cal.jpg" alt = "mlbb team3 player 4" />
                <figcaption >CALYPSO</figcaption>
            </figure>

            <figure id="roster-member"><!-- Figure Element 5 -->
                <img src ="../images/valiant-empy/val-wal.jpg" alt = "mlbb team3 player 5" />
                <figcaption >Wally Revillame.</figcaption>
            </figure>

            <figure id="roster-member"><!-- Figure Element 6 -->
                <img src ="../images/valiant-empy/val-all.jpg" alt = "mlbb team3 manager" />
