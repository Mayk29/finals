...
<!DOCTYPE html>
	...
	Section: WD-202
	Site Name: Valiant Esports - mlbb_4.php
	Date: April 2024
	-->
<html lang = "en">

<head>
	<title>Valiant Hearts MLBB | Valiant Esports</title>
	<meta charset = "utf-8">
...
<body>
    ...
    <nav>
		...
		<main>
			<div class = "grid">
            <aside >
                <p>VALIANT HEARTS ROSTER</p>
            </aside>
    
            <figure  id="roster-member"><!-- Figure Element 1 -->
                <img src ="../images/valiant-hearts/val-yan.jpg" alt = "mlbb team4 player 1" />
				<figcaption>Yanieee</figcaption>
            </figure>
    
            <figure id="roster-member" ><!-- Figure Element 2 -->
                <img src ="../images/valiant-hearts/val-ora.jpg" alt = "mlbb team4 player 2" />
                <figcaption >Orange.</figcaption>
            </figure>
            
            <figure id="roster-member"><!-- Figure Element 3 -->
                <img src ="../images/valiant-hearts/val-art.jpg" alt = "mlbb team4 player 3" />
                <figcaption >Artoria</figcaption>
            </figure>

            <figure id="roster-member"><!-- Figure Element 4 -->
                <img src ="../images/valiant-hearts/val-sai.jpg" alt = "mlbb team4 player 4" />
                <figcaption >Saire.</figcaption>
            </figure>

            <figure id="roster-member"><!-- Figure Element 5 -->
                <img src ="../images/valiant-hearts/val-tba.jpg" alt = "mlbb team4 player 5" />
