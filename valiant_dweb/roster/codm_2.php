...
<!DOCTYPE html>
	...
	Section: WD-202
	Site Name: Valiant Esports - codm_2.php
	Date: April 2024
	-->
<html lang = "en">

<head>
	<title>CODM Hearts | Valiant Esports</title>
	<meta charset = "utf-8">
...
<body>
    ...
    <nav>
		...
		<main >
			<div class = "grid">
            <aside >
                <p>VALIANT CODM HEARTS</p>
            </aside>
    
            <figure  id="roster-member"><!-- Figure Element 1 -->
                <img src ="../images/valiant-codm-hearts/val-mad.jpg" alt = "codm team2 player 1" />
				<figcaption>MADDAMN</figcaption>
            </figure>
    
            <figure id="roster-member" ><!-- Figure Element 2 -->
                <img src ="../images/valiant-codm-hearts/val-anm.jpg" alt = "codm team2 player 2" />
                <figcaption >ANM LunaLX</figcaption>
            </figure>
            
            <figure id="roster-member"><!-- Figure Element 3 -->
                <img src ="../images/valiant-codm-hearts/val-clas.jpg" alt = "codm team2 player 3" />
                <figcaption >ANM Clas6ixLX</figcaption>
            </figure>

            <figure id="roster-member"><!-- Figure Element 4 -->
                <img src ="../images/valiant-codm-hearts/val-tba.jpg" alt = "codm team2 player 4" />
                <figcaption >TBA</figcaption>
            </figure>

            <figure id="roster-member"><!-- Figure Element 5 -->
                <img src ="../images/valiant-codm-hearts/val-tba.jpg" alt = "codm team2 player 5" />
                <figcaption >TBA</figcaption>
            </figure>
		</div>
