...
<!DOCTYPE html>
	...
	Section: WD-202
	Site Name: Valiant Esports - mlbb_1.php
	Date: April 2024
	-->
<html lang = "en">

<head>
	<title>Valiant Seraphicus | Valiant Esports</title>
	<meta charset = "utf-8">
...
<body>
    ...
    <nav>
		...
		<main>
			<div class = "grid">
            <aside >
                <p>VALIANT SERAPHICUS ROSTER</p>
            </aside>
    
            <figure id="roster-member"><!-- Figure Element 1 -->
                <img src ="../images/valiant-seraphicus/val-jie.jpg" alt = "mlbb team1 player 1" />
				<figcaption>Jiejiesz</figcaption>
            </figure>
    
            <figure id="roster-member"><!-- Figure Element 2 -->
                <img src ="../images/valiant-seraphicus/val-step.jpg" alt = "mlbb team1 player 2" />
                <figcaption >StepBro.</figcaption>
            </figure>
            
            <figure id="roster-member"><!-- Figure Element 3 -->
                <img src ="../images/valiant-seraphicus/val-chen.jpg" alt = "mlbb team1 player 3" />
                <figcaption >Chen.</figcaption>
            </figure>

            <figure id="roster-member"><!-- Figure Element 4 -->
                <img src ="../images/valiant-seraphicus/val-dream.jpg" alt = "mlbb team1 player 4" />
                <figcaption >Dream</figcaption>
            </figure>

            <figure id="roster-member"><!-- Figure Element 5 -->
                <img src ="../images/valiant-seraphicus/val-ch.jpg" alt = "mlbb team1 player 5" />
                <figcaption >CH U KS</figcaption>
            </figure id="roster-member">

            <figure id="roster-member"><!-- Figure Element 6 -->
                <img src ="../images/valiant-seraphicus/val-gam.jpg" alt = "mlbb team1 coach" />
                <figcaption >Gamamochi</figcaption>
            </figure>

            <figure id="roster-member"><!-- Figure Element 7 -->
                <img src ="../images/valiant-seraphicus/val-ang.jpg" alt = "mlbb team1 manager" />
                <figcaption >Angkol Kenken</figcaption>
            </figure>
		</div>
